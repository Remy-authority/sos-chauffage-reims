...
- **Ce site : dépannage chauffage et chaudière à Reims (51), site n°5 du portefeuille.** Domaine
  pressenti `sos-chauffage-reims.fr` (disponible, pas encore acheté). Dupliqué le 27/07/2026 depuis
  `sos-debouchage-metz.fr` (site n°3, validé par Rémy), qui porte le système de design PROTEC-DARD.
  ⏰ IMPÉRATIF CALENDAIRE : mise en ligne AVANT FIN SEPTEMBRE 2026 pour être mûr au pic de la
  saison de chauffe (octobre-novembre). Ce site est prioritaire sur toute autre tâche du portefeuille.
...
- **Référence unique et obligatoire : PROTEC-DARD** (landing créée par Rémy, réussie).
  ...
  (motion, typo, rythme) mais créer une IDENTITÉ DISTINCTE pour Reims : palette propre au métier
  chauffage, images nouvelles, variations de sections, textes 100 % nouveaux. Le rendu ne doit
  ressembler ni à Angers/Annecy, ni être un clone pixel par pixel de Metz ou de Dijon.
...
- Chaque page doit avoir : visuels de qualité, respiration, hiérarchie claire, CTA visibles,
  cohérence de la charte (palette à définir pour le métier chauffage + accent urgence,
  différente de celles d'Angers, d'Annecy, de Metz ET de Dijon).
