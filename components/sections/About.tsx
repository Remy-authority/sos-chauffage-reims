        ...
        <div className="grid items-start gap-16 lg:grid-cols-12">
            ...
            <AnimatedSection delay={0.25} className="mt-10">
              ...
              <ul className="flex flex-wrap gap-2.5">
                {methods.map((m) => (
                  <li
                    key={m}
                    className="inline-flex items-center gap-2 rounded-full border border-craie-200 bg-white px-4 py-2 text-sm text-craie-700"
                  >
                    <span className="h-1.5 w-1.5 rounded-full bg-braise-500" aria-hidden="true" />
                    {m}
                  </li>
                ))}
              </ul>
          ...
          <div className="lg:col-span-5">
            <AnimatedSection delay={0.2} className="relative mx-auto max-w-sm lg:max-w-none">
              <div
                aria-hidden="true"
                className="absolute -inset-6 -z-10 rounded-[3rem] bg-gradient-to-br from-flamme-500/15 via-transparent to-braise-500/10 blur-2xl"
              />
