        ...
        <div className="mt-16 grid gap-6 md:grid-cols-2">
          {siteConfig.whyUs.map((item, idx) => (
            <AnimatedSection
              key={item.title}
              delay={(idx % 2) * 0.1}
              className="group relative overflow-hidden rounded-bloc border border-craie-200 bg-white p-8 text-center sm:text-left transition-all duration-300 hover:-translate-y-1 hover:border-flamme-400/40 hover:shadow-pose-forte"
            >
              <span
                aria-hidden="true"
              ...
              />
              <span className="relative mx-auto flex h-14 w-14 items-center sm:mx-0 justify-center rounded-2xl bg-fonte-950 text-flamme-300">
