      ...
      <div className="mx-auto max-w-7xl px-6 py-20 lg:px-10">
        ...
        <div className="mt-16 flex flex-col gap-4 border-t border-fonte-800 pt-8 text-sm text-craie-400 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex flex-wrap gap-x-6 gap-y-2">
            <Link href="/mentions-legales" className="transition-colors hover:text-braise-300">
              Mentions légales
            </Link>
            <Link href="/politique-confidentialite" className="transition-colors hover:text-braise-300">
              Confidentialité
            </Link>
            <Link href="/politique-cookies" className="transition-colors hover:text-braise-300">
              Cookies
            </Link>
            <Link href="/cgu" className="transition-colors hover:text-braise-300">
              CGU
            </Link>
          </div>
        </div>
